package com.example.myandroidproject.Data
...
class UserData(var navController: NavHostController, var context: Context){
...
//            progress.dismiss()
            Toast.makeText(context,"Your email and password cannot be blank", Toast.LENGTH_LONG).show()
            return
